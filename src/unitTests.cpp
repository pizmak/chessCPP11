...
void boardUnitTest() {
    ...
    std::list<Move> moveList = {
        ...
        {notation2Number("e1"), notation2Number("g1"), 0, Piece::empty, MoveFlags::castling | MoveFlags::K_castling},
        ...
        {notation2Number("e8"), notation2Number("c8"), 0, Piece::empty, MoveFlags::castling | MoveFlags::q_castling},
